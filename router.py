...
from resources.dashboard import GrainsStatistics, TitleInfo, Minion
...
from period.period_task import Period, PeriodList, Reopen, Pause, Play
...
api.add_resource(Play, "/saltshaker/api/v1.0/period/play/<string:period_id>")
